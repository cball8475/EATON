...
| **GET** | **`/scoreboard`** | **730–733** | Single-row EHS safety pulse metrics (TRIR, recordables, observations, man-hours) |
| **PATCH** | **`/scoreboard`** | **735–750** | Update scoreboard fields — auto-stamps `last_updated` |
| GET | `/stats` | 752–end | Counts dashboard — read-heavy, always cheap |
